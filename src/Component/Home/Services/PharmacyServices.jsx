...
const DefaultIcon = () => <div className="w-6 h-6 bg-gray-200 rounded"></div>;
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-4">
            Support Tailored to <span className="text-blue-600">Your Needs</span>
          </h2>
          <p className="text-base text-gray-600 max-w-2xl mx-auto leading-relaxed mb-6">
            ...
            delivered remotely. Build a customised programme to meet your specific
            needs and empower your practice to deliver exceptional care.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-gradient-to-br from-gray-50 to-gray-100/50 rounded-2xl p-4 sm:p-6 hover:from-white hover:to-blue-50/30 hover:shadow-xl transition-all duration-500 border border-gray-100 hover:border-blue-200 overflow-hidden min-w-0"
              >
                <div className="absolute -top-2 -right-2 w-20 h-20 bg-blue-500/10 rounded-full group-hover:bg-blue-500/20 transition-colors duration-300"></div>
                <div className="relative flex flex-col h-full">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="relative">
                      <div className="flex items-center justify-center w-12 h-12 bg-white rounded-xl shadow-sm group-hover:shadow-md group-hover:scale-110 transition-all duration-300 border border-gray-100 group-hover:border-blue-200">
                        <IconComponent
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed flex-1 group-hover:text-gray-700 transition-colors duration-300">
                    {service.description}
                  </p>
